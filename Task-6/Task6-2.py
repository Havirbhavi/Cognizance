...
df['BsmtQual'].fillna('Value not foundn', inplace=True)
df.tail(10)
...
df['BsmtCond'].fillna('No condition available', inplace=True)
df.tail(10)
...
df['BsmtExposure'].fillna('No exposure found', inplace=True)
df.tail(10)
...
df['BsmtFinType1'].fillna('value is not assigned ', inplace=True)
df.tail(10)
...
df['BsmtFinType2'].fillna('values are not found', inplace=True)
df.tail(10)
